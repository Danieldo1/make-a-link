...
const PreviewLinkTab = ({page}) => {
  ...
  return (
    <SectionBox>
        ...
        <div>
            <Link target='_blank' href={`/${page.username}`} className='text-center mt-4 flex gap-2 items-center hover:underline underline-offset-2 decoration-indigo-500 decoration-3  justify-center'>
